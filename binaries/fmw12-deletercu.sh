...
$FMW_HOME/oracle_common/bin/rcu -silent -dropRepository -connectString soadb:1521:SOAQ02 -dbUser SYS -dbRole SYSDBA -schemaPrefix ALL -component STB -component ESS -component OPSS -component SOAINFRA -component UCSUMS -component IAU -component IAU_APPEND -component IAU_VIEWER -component MDS -component WLS -f < $PWD/$RCU_SOA_PWD